...
type GoogleOIDC struct {
	...
	OidcEndSessionUrl *string `json:"oidc_end_session_url,omitempty"`
...
// GetOidcEndSessionUrl returns the OidcEndSessionUrl field value if set, zero value otherwise.
func (o *GoogleOIDC) GetOidcEndSessionUrl() string {
	if o == nil || IsNil(o.OidcEndSessionUrl) {
		var ret string
		return ret
	}
	return *o.OidcEndSessionUrl
}

// GetOidcEndSessionUrlOk returns a tuple with the OidcEndSessionUrl field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *GoogleOIDC) GetOidcEndSessionUrlOk() (*string, bool) {
	if o == nil || IsNil(o.OidcEndSessionUrl) {
		return nil, false
	}
	return o.OidcEndSessionUrl, true
}
...
// SetOidcEndSessionUrl gets a reference to the given string and assigns it to the OidcEndSessionUrl field.
func (o *GoogleOIDC) SetOidcEndSessionUrl(v string) {
	o.OidcEndSessionUrl = &v
}
...
func (o GoogleOIDC) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.OidcEndSessionUrl) {
		toSerialize["oidc_end_session_url"] = o.OidcEndSessionUrl
	}
