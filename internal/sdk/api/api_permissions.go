...
Available from API version 2.9.0+. Deletes a role grant for a subject. It can also delete role grants for a subject with objects if object info is provided. The API token must have the "Permissions > Write" scope.
