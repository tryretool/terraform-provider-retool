...
type UsersUserIdGet200ResponseData struct {
	...
	// The groups that the user is part of. Only included when `includeGroups` query parameter is `true`.
	Groups []UsersUserIdGet200ResponseDataGroupsInner `json:"groups,omitempty"`
}
...
func (o *UsersUserIdGet200ResponseData) SetSeatTypeNil() {
	o.SeatType.Set(nil)
}
...
func (o *UsersUserIdGet200ResponseData) GetGroups() []UsersUserIdGet200ResponseDataGroupsInner {
	if o == nil || IsNil(o.Groups) {
		var ret []UsersUserIdGet200ResponseDataGroupsInner
		return ret
	}
	return o.Groups
}
...
// SetGroups gets a reference to the given []UsersUserIdGet200ResponseDataGroupsInner and assigns it to the Groups field.
