...
## SourceControlDeploymentsGet

> SourceControlDeploymentsGet200Response SourceControlDeploymentsGet(ctx).Execute()
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.SourceControlAPI.SourceControlDeploymentsGet(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `SourceControlAPI.SourceControlDeploymentsGet``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `SourceControlDeploymentsGet`: SourceControlDeploymentsGet200Response
	fmt.Fprintf(os.Stdout, "Response from `SourceControlAPI.SourceControlDeploymentsGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiSourceControlDeploymentsGetRequest struct via the builder pattern


### Return type

[**SourceControlDeploymentsGet200Response**](SourceControlDeploymentsGet200Response.md)
