...
`func NewUserAttributesGet200ResponseDataInner(id string, name string, label string, dataType string, intercomAttributeName NullableString, ) *UserAttributesGet200ResponseDataInner`
...
`func (o *UserAttributesGet200ResponseDataInner) HasDefaultValue() bool`
