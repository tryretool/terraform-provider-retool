...
------------- | ------------- | -------------
[**UserInvitesGet**](UserInvitesAPI.md#UserInvitesGet) | **Get** /user_invites | List user invites
[**UserInvitesPost**](UserInvitesAPI.md#UserInvitesPost) | **Post** /user_invites | Create a user invite
[**UserInvitesUserInviteIdDelete**](UserInvitesAPI.md#UserInvitesUserInviteIdDelete) | **Delete** /user_invites/{userInviteId} | Delete a user invite
[**UserInvitesUserInviteIdGet**](UserInvitesAPI.md#UserInvitesUserInviteIdGet) | **Get** /user_invites/{userInviteId} | Get a user invite
[**UserInvitesUserInviteIdUserAttributesAttributeNameDelete**](UserInvitesAPI.md#UserInvitesUserInviteIdUserAttributesAttributeNameDelete) | **Delete** /user_invites/{userInviteId}/user_attributes/{attributeName} | Delete a user attribute on a user invite
[**UserInvitesUserInviteIdUserAttributesPost**](UserInvitesAPI.md#UserInvitesUserInviteIdUserAttributesPost) | **Post** /user_invites/{userInviteId}/user_attributes | Add or update user attributes on a user invite
...
func main() {
	...
	resp, r, err := apiClient.UserInvitesAPI.UserInvitesGet(context.Background()).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UserInvitesAPI.UserInvitesGet``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UserInvitesGet`: UserInvitesGet200Response
	fmt.Fprintf(os.Stdout, "Response from `UserInvitesAPI.UserInvitesGet`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserInvitesAPI.UserInvitesPost(context.Background()).UserInvitesPostRequest(userInvitesPostRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UserInvitesAPI.UserInvitesPost``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UserInvitesPost`: UserInvitesPost200Response
	fmt.Fprintf(os.Stdout, "Response from `UserInvitesAPI.UserInvitesPost`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	r, err := apiClient.UserInvitesAPI.UserInvitesUserInviteIdDelete(context.Background(), userInviteId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UserInvitesAPI.UserInvitesUserInviteIdDelete``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserInvitesAPI.UserInvitesUserInviteIdGet(context.Background(), userInviteId).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UserInvitesAPI.UserInvitesUserInviteIdGet``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UserInvitesUserInviteIdGet`: UserInvitesUserInviteIdGet200Response
	fmt.Fprintf(os.Stdout, "Response from `UserInvitesAPI.UserInvitesUserInviteIdGet`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserInvitesAPI.UserInvitesUserInviteIdUserAttributesAttributeNameDelete(context.Background(), userInviteId, attributeName).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UserInvitesAPI.UserInvitesUserInviteIdUserAttributesAttributeNameDelete``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	...
	fmt.Fprintf(os.Stdout, "Response from `UserInvitesAPI.UserInvitesUserInviteIdUserAttributesAttributeNameDelete`: %v\n", resp)
}
```
...
func main() {
	...
	configuration := openapiclient.NewConfiguration()
	apiClient := openapiclient.NewAPIClient(configuration)
	resp, r, err := apiClient.UserInvitesAPI.UserInvitesUserInviteIdUserAttributesPost(context.Background(), userInviteId).UserInvitesUserInviteIdUserAttributesPostRequest(userInvitesUserInviteIdUserAttributesPostRequest).Execute()
	if err != nil {
		fmt.Fprintf(os.Stderr, "Error when calling `UserInvitesAPI.UserInvitesUserInviteIdUserAttributesPost``: %v\n", err)
		fmt.Fprintf(os.Stderr, "Full HTTP response: %v\n", r)
	}
	// response from `UserInvitesUserInviteIdUserAttributesPost`: UserInvitesUserInviteIdUserAttributesPost200Response
	fmt.Fprintf(os.Stdout, "Response from `UserInvitesAPI.UserInvitesUserInviteIdUserAttributesPost`: %v\n", resp)
}
```
