...
**DefaultValue** | Pointer to **NullableString** | The value to use in any environment where no value was specifically set for that environment | [optional] 
...
`func (o *ConfigurationVariablesGet200ResponseDataInner) GetDefaultValue() string`

GetDefaultValue returns the DefaultValue field if non-nil, zero value otherwise.

### GetDefaultValueOk

`func (o *ConfigurationVariablesGet200ResponseDataInner) GetDefaultValueOk() (*string, bool)`
...
`func (o *ConfigurationVariablesGet200ResponseDataInner) SetDefaultValue(v string)`

SetDefaultValue sets DefaultValue field to given value.

### HasDefaultValue

`func (o *ConfigurationVariablesGet200ResponseDataInner) HasDefaultValue() bool`

HasDefaultValue returns a boolean if a field has been set.

### SetDefaultValueNil

`func (o *ConfigurationVariablesGet200ResponseDataInner) SetDefaultValueNil(b bool)`

 SetDefaultValueNil sets the value for DefaultValue to be an explicit nil

### UnsetDefaultValue
`func (o *ConfigurationVariablesGet200ResponseDataInner) UnsetDefaultValue()`
