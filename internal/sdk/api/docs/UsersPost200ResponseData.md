...
`func (o *UsersPost200ResponseData) GetSeatType() string`

GetSeatType returns the SeatType field if non-nil, zero value otherwise.

### GetSeatTypeOk

`func (o *UsersPost200ResponseData) GetSeatTypeOk() (*string, bool)`
...
`func (o *UsersPost200ResponseData) SetSeatType(v string)`

SetSeatType sets SeatType field to given value.

### HasSeatType

`func (o *UsersPost200ResponseData) HasSeatType() bool`

HasSeatType returns a boolean if a field has been set.

### SetSeatTypeNil

`func (o *UsersPost200ResponseData) SetSeatTypeNil(b bool)`

 SetSeatTypeNil sets the value for SeatType to be an explicit nil

### UnsetSeatType
`func (o *UsersPost200ResponseData) UnsetSeatType()`
