...
`func (o *GoogleOIDC) SetOidcEndSessionUrl(v string)`

SetOidcEndSessionUrl sets OidcEndSessionUrl field to given value.

### HasOidcEndSessionUrl

`func (o *GoogleOIDC) HasOidcEndSessionUrl() bool`
