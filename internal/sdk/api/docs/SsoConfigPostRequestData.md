...
`func (o *SsoConfigPostRequestData) GetOidcEndSessionUrl() string`

GetOidcEndSessionUrl returns the OidcEndSessionUrl field if non-nil, zero value otherwise.

### GetOidcEndSessionUrlOk

`func (o *SsoConfigPostRequestData) GetOidcEndSessionUrlOk() (*string, bool)`
...
`func (o *SsoConfigPostRequestData) SetOidcEndSessionUrl(v string)`

SetOidcEndSessionUrl sets OidcEndSessionUrl field to given value.

### HasOidcEndSessionUrl

`func (o *SsoConfigPostRequestData) HasOidcEndSessionUrl() bool`
