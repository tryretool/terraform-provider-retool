...
// checks if the SourceControlConfigPutRequestConfigOneOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceControlConfigPutRequestConfigOneOf{}
...
type _SourceControlConfigPutRequestConfigOneOf SourceControlConfigPutRequestConfigOneOf
...
func NewSourceControlConfigPutRequestConfigOneOf(config SourceControlConfigPutRequestConfigOneOfConfig, provider string, org string, repo string, defaultBranch string) *SourceControlConfigPutRequestConfigOneOf {
	this := SourceControlConfigPutRequestConfigOneOf{}
	this.Config = config
...
func (o *SourceControlConfigPutRequestConfigOneOf) GetConfig() SourceControlConfigPutRequestConfigOneOfConfig {
	if o == nil {
		var ret SourceControlConfigPutRequestConfigOneOfConfig
		return ret
	}
...
func (o *SourceControlConfigPutRequestConfigOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varSourceControlConfigPutRequestConfigOneOf := _SourceControlConfigPutRequestConfigOneOf{}

	err = json.Unmarshal(data, &varSourceControlConfigPutRequestConfigOneOf)

	if err != nil {
		return err
	}

	*o = SourceControlConfigPutRequestConfigOneOf(varSourceControlConfigPutRequestConfigOneOf)
...
type NullableSourceControlConfigPutRequestConfigOneOf struct {
	value *SourceControlConfigPutRequestConfigOneOf
	isSet bool
}
...
func NewNullableSourceControlConfigPutRequestConfigOneOf(val *SourceControlConfigPutRequestConfigOneOf) *NullableSourceControlConfigPutRequestConfigOneOf {
	return &NullableSourceControlConfigPutRequestConfigOneOf{value: val, isSet: true}
}
