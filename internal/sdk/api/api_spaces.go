...
Copies apps, queries, resources, and workflows from one space to another and returns the result. Requires the `spaces:write` scope.
...
Returns a list of child spaces within the current space. Requires the `spaces:read` scope.
...
Deletes the specified space. Requires the `spaces:write` scope.
...
/*
SpacesSpaceIdGet Get a space

Returns the specified space. Requires the `spaces:read` scope.
...
/*
SpacesSpaceIdPut Update a space

Updates the specified space and returns the updated space. Requires the `spaces:write` scope.
