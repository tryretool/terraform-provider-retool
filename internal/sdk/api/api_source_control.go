...
type ApiSourceControlBranchesPostRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
	sourceControlBranchesPostRequest *SourceControlBranchesPostRequest
}

func (r ApiSourceControlBranchesPostRequest) SourceControlBranchesPostRequest(sourceControlBranchesPostRequest SourceControlBranchesPostRequest) ApiSourceControlBranchesPostRequest {
	r.sourceControlBranchesPostRequest = &sourceControlBranchesPostRequest
	return r
}

func (r ApiSourceControlBranchesPostRequest) Execute() (*SourceControlBranchesPost200Response, *http.Response, error) {
	return r.ApiService.SourceControlBranchesPostExecute(r)
}

/*
SourceControlBranchesPost Create a branch

Creates a Retool branch, optionally initialized with a single source-control element. Requires the `source_control:write` scope.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSourceControlBranchesPostRequest
*/
func (a *SourceControlAPIService) SourceControlBranchesPost(ctx context.Context) ApiSourceControlBranchesPostRequest {
	return ApiSourceControlBranchesPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return SourceControlBranchesPost200Response
func (a *SourceControlAPIService) SourceControlBranchesPostExecute(r ApiSourceControlBranchesPostRequest) (*SourceControlBranchesPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SourceControlBranchesPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.SourceControlBranchesPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/source_control/branches"
	...
	// body params
	localVarPostBody = r.sourceControlBranchesPostRequest
...
type ApiSourceControlBranchesResetPostRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
	sourceControlBranchesResetPostRequest *SourceControlBranchesResetPostRequest
}

func (r ApiSourceControlBranchesResetPostRequest) SourceControlBranchesResetPostRequest(sourceControlBranchesResetPostRequest SourceControlBranchesResetPostRequest) ApiSourceControlBranchesResetPostRequest {
	r.sourceControlBranchesResetPostRequest = &sourceControlBranchesResetPostRequest
	return r
}

func (r ApiSourceControlBranchesResetPostRequest) Execute() (*SourceControlBranchesResetPost200Response, *http.Response, error) {
	return r.ApiService.SourceControlBranchesResetPostExecute(r)
}

/*
SourceControlBranchesResetPost Reset a branch from remote

Resets a Retool app branch by discarding Retool-local branch changes and reloading app contents from the specified remote Git branch. Updates to non-page elements on the branch are not persisted. Requires the `source_control:write` scope.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSourceControlBranchesResetPostRequest
*/
func (a *SourceControlAPIService) SourceControlBranchesResetPost(ctx context.Context) ApiSourceControlBranchesResetPostRequest {
	return ApiSourceControlBranchesResetPostRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SourceControlBranchesResetPost200Response
func (a *SourceControlAPIService) SourceControlBranchesResetPostExecute(r ApiSourceControlBranchesResetPostRequest) (*SourceControlBranchesResetPost200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SourceControlBranchesResetPost200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.SourceControlBranchesResetPost")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/source_control/branches/reset"
	...
	// body params
	localVarPostBody = r.sourceControlBranchesResetPostRequest
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
/*
SourceControlConfigDelete Delete source control configuration

Deletes the source control configuration for the organization or space. Requires the `source_control:write` scope.
...
Returns the source control configuration for the organization or space. Requires the `source_control:read` scope.
...
Creates source control configuration for the organization or space and returns the created configuration. Returns an error if a configuration is already set. Requires the `source_control:write` scope.
...
Creates or updates the source control configuration for the organization or space. Overwrites any existing configuration. Requires the `source_control:write` scope.
...
/*
SourceControlDeployPost Deploy latest changes

Deploys the latest changes from the source control provider to the instance. Use the GET /deployment/{id} endpoint to check the status of the deployment. Requires the `source_control:deploy` scope.
...
Returns the status of the specified deployment. Requires the `source_control:deploy` scope.
...
type ApiSourceControlDeploymentsGetRequest struct {
	ctx context.Context
	ApiService *SourceControlAPIService
}

func (r ApiSourceControlDeploymentsGetRequest) Execute() (*SourceControlDeploymentsGet200Response, *http.Response, error) {
	return r.ApiService.SourceControlDeploymentsGetExecute(r)
}

/*
SourceControlDeploymentsGet List source control deployments

Returns a list of source control deployments in reverse chronological order. Returns the same data shown in the deploy dashboard. Requires the `source_control:deploy` scope.

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiSourceControlDeploymentsGetRequest
*/
func (a *SourceControlAPIService) SourceControlDeploymentsGet(ctx context.Context) ApiSourceControlDeploymentsGetRequest {
	return ApiSourceControlDeploymentsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return SourceControlDeploymentsGet200Response
func (a *SourceControlAPIService) SourceControlDeploymentsGetExecute(r ApiSourceControlDeploymentsGetRequest) (*SourceControlDeploymentsGet200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SourceControlDeploymentsGet200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SourceControlAPIService.SourceControlDeploymentsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/source_control/deployments"
...
Returns the source control settings for the organization or space. Requires the `source_control:read` scope.
...
/*
SourceControlTestConnectionGet Test source control connection

Tests the connection to the source control provider and returns whether the connection was successful. Requires the `source_control:read` scope.
...
Attempts a test deployment (no permanent changes) using the provided commit SHA to determine whether the commit is valid. Requires the `source_control:test_deploy` scope.
