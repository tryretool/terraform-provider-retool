...
/*
SourceControlManifestsGet List release manifests

Returns a list of all release manifests available in the source control repository. Requires the `source_control:releases_read` scope.
...
NOTE: This endpoint is deprecated. Use the POST /manifests/{manifestName}/{elementUuid}/delete endpoint instead. 

Pushes a branch to the source control repository that deletes the entry for the specified app from the named release manifest. Requires the `source_control:releases_write` scope.
...
Pushes a branch to the source control repository that updates the release version of the specified app in the named release manifest. If the manifest does not already exist, it will be created in the branch. Requires the `source_control:releases_write` scope.
...
Pushes a branch to the source control repository that deletes the named release manifest. Requires the `source_control:releases_write` scope.
...
Pushes a branch to the source control repository that deletes the entry for the specified element from the named release manifest. Requires the `source_control:releases_write` scope.
...
Pushes a branch to the source control repository that updates the release version of the specified element in the named release manifest. If the manifest does not already exist, it will be created in the branch. Requires the `source_control:releases_write` scope.
...
/*
SourceControlManifestsManifestNameGet Get a release manifest

Returns the release manifest with the specified name from the source control repository. Requires the `source_control:releases_read` scope.
...
/*
SourceControlReleasesAppsAppUuidGet List all available releases for the given app

NOTE: This endpoint is deprecated. Use the GET /releases/{elementUuid} endpoint instead. 

Returns a list of the available releases for the app. Requires the `source_control:releases_read` scope.
...
Pushes a branch to the source control repository that creates a new release artifact with the provided version for the app based on the latest version. Requires the `source_control:releases_write` scope.
...
/*
SourceControlReleasesElementUuidGet List all available releases for the given element

Returns a list of the available releases for the element. Requires the `source_control:releases_read` scope.
