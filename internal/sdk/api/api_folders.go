...
/*
FoldersFolderIdDelete Delete a folder

Deletes the specified folder. Requires the `folders:write` scope.
...
Returns the specified folder. Requires the `folders:read` scope.
...
/*
FoldersFolderIdPatch Update a folder

Updates a folder and returns the updated folder. Requires the `folders:write` scope.
...
Returns a list of folders. Requires the `folders:read` scope.
...
/*
FoldersPost Create a folder

Creates a folder and returns the created folder. Requires the `folders:write` scope.
