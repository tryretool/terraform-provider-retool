...
// checks if the SourceControlConfigGet200ResponseDataAnyOf2Config type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceControlConfigGet200ResponseDataAnyOf2Config{}
...
type _SourceControlConfigGet200ResponseDataAnyOf2Config SourceControlConfigGet200ResponseDataAnyOf2Config
...
func NewSourceControlConfigGet200ResponseDataAnyOf2Config(url string, region string, accessKeyId string, secretAccessKey string, httpsUsername string, httpsPassword string) *SourceControlConfigGet200ResponseDataAnyOf2Config {
	this := SourceControlConfigGet200ResponseDataAnyOf2Config{}
	this.Url = url
	this.Region = region
...
func (o *SourceControlConfigGet200ResponseDataAnyOf2Config) UnmarshalJSON(data []byte) (err error) {
	...
	varSourceControlConfigGet200ResponseDataAnyOf2Config := _SourceControlConfigGet200ResponseDataAnyOf2Config{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSourceControlConfigGet200ResponseDataAnyOf2Config)

	if err != nil {
		return err
	}

	*o = SourceControlConfigGet200ResponseDataAnyOf2Config(varSourceControlConfigGet200ResponseDataAnyOf2Config)

	return err
}

type NullableSourceControlConfigGet200ResponseDataAnyOf2Config struct {
	value *SourceControlConfigGet200ResponseDataAnyOf2Config
	isSet bool
}
...
func NewNullableSourceControlConfigGet200ResponseDataAnyOf2Config(val *SourceControlConfigGet200ResponseDataAnyOf2Config) *NullableSourceControlConfigGet200ResponseDataAnyOf2Config {
	return &NullableSourceControlConfigGet200ResponseDataAnyOf2Config{value: val, isSet: true}
}
