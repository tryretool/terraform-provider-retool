...
// checks if the SourceControlConfigGet200ResponseDataOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SourceControlConfigGet200ResponseDataOneOf2{}
...
type _SourceControlConfigGet200ResponseDataOneOf2 SourceControlConfigGet200ResponseDataOneOf2
...
func NewSourceControlConfigGet200ResponseDataOneOf2(config SourceControlConfigGet200ResponseDataOneOf2Config, provider string, org string, repo string, defaultBranch string) *SourceControlConfigGet200ResponseDataOneOf2 {
	this := SourceControlConfigGet200ResponseDataOneOf2{}
	this.Config = config
...
func (o *SourceControlConfigGet200ResponseDataOneOf2) GetConfig() SourceControlConfigGet200ResponseDataOneOf2Config {
	if o == nil {
		var ret SourceControlConfigGet200ResponseDataOneOf2Config
		return ret
	}
...
func (o *SourceControlConfigGet200ResponseDataOneOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varSourceControlConfigGet200ResponseDataOneOf2 := _SourceControlConfigGet200ResponseDataOneOf2{}

	err = json.Unmarshal(data, &varSourceControlConfigGet200ResponseDataOneOf2)

	if err != nil {
		return err
	}

	*o = SourceControlConfigGet200ResponseDataOneOf2(varSourceControlConfigGet200ResponseDataOneOf2)
...
type NullableSourceControlConfigGet200ResponseDataOneOf2 struct {
	value *SourceControlConfigGet200ResponseDataOneOf2
	isSet bool
}
...
func NewNullableSourceControlConfigGet200ResponseDataOneOf2(val *SourceControlConfigGet200ResponseDataOneOf2) *NullableSourceControlConfigGet200ResponseDataOneOf2 {
	return &NullableSourceControlConfigGet200ResponseDataOneOf2{value: val, isSet: true}
}
