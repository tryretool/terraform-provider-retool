...
// checks if the PermissionsRevokePost200ResponseDataInnerAnyOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PermissionsRevokePost200ResponseDataInnerAnyOf1{}
...
type _PermissionsRevokePost200ResponseDataInnerAnyOf1 PermissionsRevokePost200ResponseDataInnerAnyOf1
...
func NewPermissionsRevokePost200ResponseDataInnerAnyOf1(type_ string, id string, accessLevel string) *PermissionsRevokePost200ResponseDataInnerAnyOf1 {
	this := PermissionsRevokePost200ResponseDataInnerAnyOf1{}
	this.Type = type_
	this.Id = id
...
func (o *PermissionsRevokePost200ResponseDataInnerAnyOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varPermissionsRevokePost200ResponseDataInnerAnyOf1 := _PermissionsRevokePost200ResponseDataInnerAnyOf1{}

	err = json.Unmarshal(data, &varPermissionsRevokePost200ResponseDataInnerAnyOf1)

	if err != nil {
		return err
	}

	*o = PermissionsRevokePost200ResponseDataInnerAnyOf1(varPermissionsRevokePost200ResponseDataInnerAnyOf1)
...
type NullablePermissionsRevokePost200ResponseDataInnerAnyOf1 struct {
	value *PermissionsRevokePost200ResponseDataInnerAnyOf1
	isSet bool
}
...
func NewNullablePermissionsRevokePost200ResponseDataInnerAnyOf1(val *PermissionsRevokePost200ResponseDataInnerAnyOf1) *NullablePermissionsRevokePost200ResponseDataInnerAnyOf1 {
	return &NullablePermissionsRevokePost200ResponseDataInnerAnyOf1{value: val, isSet: true}
}
