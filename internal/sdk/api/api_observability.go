...
/*
ObservabilityConfigConfigIdDelete Delete an observability configuration
...
/*
ObservabilityConfigConfigIdPut Update an observability configuration
...
/*
ObservabilityConfigGet List observability configurations

Returns a list of observability configurations for the organization. Requires the `observability:read` scope.
...
/*
ObservabilityConfigPost Create an observability configuration
...
/*
ObservabilityProviderProviderTestPost Send a test error event

Sends a test error event to the specified observability provider. Requires the `observability:read` scope.
