...
// checks if the Bitbucket1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Bitbucket1{}

// Bitbucket1 struct for Bitbucket1
type Bitbucket1 struct {
	Config Bitbucket1Config `json:"config"`
...
func (o Bitbucket1) MarshalJSON() ([]byte, error) {
...
func (o Bitbucket1) ToMap() (map[string]interface{}, error) {
...
func (o *Bitbucket1) UnmarshalJSON(data []byte) (err error) {
	...
	varBitbucket1 := _Bitbucket1{}

	err = json.Unmarshal(data, &varBitbucket1)

	if err != nil {
		return err
	}

	*o = Bitbucket1(varBitbucket1)
...
type NullableBitbucket1 struct {
	value *Bitbucket1
	isSet bool
}

func (v NullableBitbucket1) Get() *Bitbucket1 {
	return v.value
}

func (v *NullableBitbucket1) Set(val *Bitbucket1) {
	v.value = val
	v.isSet = true
}

func (v NullableBitbucket1) IsSet() bool {
	return v.isSet
}

func (v *NullableBitbucket1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBitbucket1(val *Bitbucket1) *NullableBitbucket1 {
	return &NullableBitbucket1{value: val, isSet: true}
}

func (v NullableBitbucket1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBitbucket1) UnmarshalJSON(src []byte) error {
	v.isSet = true
