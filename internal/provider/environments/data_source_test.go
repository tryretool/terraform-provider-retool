		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("data.retool_environments.test_environments", "environments.0.name", "production"),
					...
					resource.TestCheckResourceAttrSet("data.retool_environments.test_environments", "environments.1.id"),
					resource.TestCheckResourceAttrSet("data.retool_environments.test_environments", "environments.1.name"),
					resource.TestCheckResourceAttr("data.retool_environments.test_environments", "environments.1.name", "staging"),
					resource.TestCheckResourceAttrSet("data.retool_environments.test_environments", "environments.1.description"),
					resource.TestCheckResourceAttrSet("data.retool_environments.test_environments", "environments.1.default"),
					resource.TestCheckResourceAttrSet("data.retool_environments.test_environments", "environments.1.created_at"),
					resource.TestCheckResourceAttrSet("data.retool_environments.test_environments", "environments.1.updated_at"),
				),
			},
		},
	})
